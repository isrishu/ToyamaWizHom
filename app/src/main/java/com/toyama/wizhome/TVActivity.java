...
public class TVActivity extends Activity {
    ...
    ImageView imgPower,imgVolumeUp,imgVolumeDown,imgChannelUp,imgChannelDown,imgPlay,imgPause,imgStop,imgForward,imgRewind;
    ...
    private void showPopupMessage(final String msg) {
        TVActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(TVActivity.this);

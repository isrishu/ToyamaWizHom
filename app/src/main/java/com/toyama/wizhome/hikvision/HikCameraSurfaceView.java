...
public class HikCameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
...
//    private Player player = null;
    public static int playPort = -1;

    public HikCameraSurfaceView(Context context) {
        super(context);
    ...
    public HikCameraSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public HikCameraSurfaceView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            playPort = -1;
    ...
    private void ToastText(String st) {
